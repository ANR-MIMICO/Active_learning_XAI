...
\begin{frame}[fragile]{Motivation: Tipping Points in Dual Spaces}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{cireco_pdp_ice_density_price.png}
      \begin{itemize}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{shap_RF_conv(1).png}
      \begin{itemize}
...
\begin{frame}[fragile]{The Active Learning Pipeline Architecture}
  \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth, height=0.75\textheight, keepaspectratio]{pipeline.png}
