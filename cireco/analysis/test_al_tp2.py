...
#     random_state=42,    # pour reproduire le split
#     shuffle=True        # mélange les données (par défaut)
# )
# 
# =============================================================================
...
y2_doe =  mlp.predict(x_doe_scaled)
...
feature_names = ["price_to_dispose", "scarcity", "cluster_spread", "km_cost","density"]
