...
products_path: /home/matt/git/cireco/data/products.csv 
processed_path: /home/matt/git/cireco/data/processed/square
visualization : no
animate : false
roads : false 
compute_regret: no 
...
product_file = "/home/matt/git/cireco/data/products.csv"
configuration_file = "/home/matt/git/cireco/bid_gen.yaml"
results_csv = sys.argv[1]
nb_sim = 21

def run_simulation():
    command = ["python", "cireco/run.py", configuration_file]
